...
> Generated `2026-09-22T08:38:23.051Z` · **768 models** across **17 price sources** · 54 models with an active promo/off-peak price · unit: **USD per 1M tokens** (CNY→USD @ 0.14) · blended = (3×input + 1×output)/4
...
| openrouter | `deepseek-v4.1-flash` | $0.300 / $1.20 | **$0.150 / $0.600** | 50% | off-peak −50% (sat/sun all-day; mon/tue/wed/thu/fri 00:00-01:00; mon/tue/wed/thu/fri 04:00-06:00; mon/tue/wed/thu/fri 10:00-00:00 UTC) | open | [direct-api](https://openrouter.ai/deepseek/deepseek-v4.1-flash) |
...
Models offered by 2+ price sources, sorted by price spread between the cheapest and priciest seller (effective price, promo applied). 124 models.
...
| deepseek | `deepseek-v4-flash` | openrouter | 198% | openrouter **$0.111** ($0.089/$0.177) · deepseek **$0.330** ($0.220/$0.660, promo) |
| zai | `glm-4-5-air` | zai | 176% | zai **$0.154** ($0.112/$0.280) · openrouter **$0.310** ($0.130/$0.850) · litellm **$0.425** ($0.200/$1.10) |
| deepseek | `deepseek-flash` | openrouter | 150% | openrouter **$0.210** ($0.120/$0.480) · litellm **$0.525** ($0.300/$1.20) |
...
| moonshot | `kimi-k2-7-code` | moonshot | 30% | moonshot **$1.03** ($0.570/$2.40, promo) · openrouter **$1.33** ($0.706/$3.21) |
| xai | `grok-4-7` | openrouter | 25% | openrouter **$2.40** ($1.60/$4.80) · litellm **$3.00** ($2.00/$6.00) |
| alibaba-modelstudio | `qwen3-next-80b-a3b` | openrouter | 20% | openrouter **$0.343** ($0.090/$1.10) · litellm **$0.412** ($0.150/$1.20) |
| deepseek | `deepseek-v4-pro` | deepseek | 20% | deepseek **$0.990** ($0.660/$1.98, promo) · openrouter **$1.19** ($0.624/$2.88) |
...
|---|---|---|---|---|---|---|---|---:|---|---|
| **OpenRouter** (`openrouter`) | aggregator | global | [openrouter.ai](https://openrouter.ai) | [pricing](https://openrouter.ai/models) | `https://openrouter.ai/api/v1` | `direct-api` | no | 371 | 2026-09-22 08:38 | ok |
| **LiteLLM price registry** (`litellm`) | aggregator | global | [github.com](https://github.com/BerriAI/litellm) | [pricing](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) | — | `direct-api` | no | 232 | 2026-09-22 08:38 | ok |
...
| **Google Gemini API** (`google`) | vendor | global | [ai.google.dev](https://ai.google.dev) | [pricing](https://ai.google.dev/gemini-api/docs/pricing) | `https://generativelanguage.googleapis.com/v1beta/openai/` | `public-page` | no | 8 | 2026-09-22 08:38 | ok |
| **DeepSeek** (`deepseek`) | vendor | cn | [platform.deepseek.com](https://platform.deepseek.com) | [pricing](https://api-docs.deepseek.com/quick_start/pricing) | `https://api.deepseek.com/v1` | `public-page` | no | 3 | 2026-09-22 08:38 | ok |
...
| openrouter | sakana | `fugu-ultra-v2` | 1M | $5.00 | $30.00 | $0.500 | **$11.25** |  | yes | [direct-api](https://openrouter.ai/sakana/fugu-ultra-v2) |
...
| openrouter | zai | `glm-5.2` | 1.05M | $0.650 | $2.04 | $0.121 | **$0.998** | batch $0.700/$2.20 | yes | [direct-api](https://openrouter.ai/z-ai/glm-5.2) |
...
| openrouter | zai | `glm-5.3` | 1.31M | $0.840 | $2.64 | $0.156 | **$1.29** | batch $0.700/$2.20 | yes | [direct-api](https://openrouter.ai/z-ai/glm-5.3) |
...
| openrouter | mistral | `devstral-2512` | 262K | $0.400 | $2.00 | $0.040 | **$0.800** |  | yes | [direct-api](https://openrouter.ai/mistralai/devstral-2512) |
...
| openrouter | moonshot | `kimi-k2.7-code` | 262K | $0.706 | $3.21 | $0.180 | **$1.33** |  | yes | [direct-api](https://openrouter.ai/moonshotai/kimi-k2.7-code) |
...
| openrouter | inclusionai | `ling-3.0-flash-vl` | 131K | $0.060 | $0.180 | $0.012 | **$0.090** |  | yes | [direct-api](https://openrouter.ai/inclusionai/ling-3.0-flash-vl) |
...
| openrouter | deepseek | `deepseek-v4-flash-vision-exp` | 1.05M | $0.220 | $0.660 | $0.0070 | **$0.330** | batch $0.110/$0.330 | yes | [direct-api](https://openrouter.ai/deepseek/deepseek-v4-flash-vision-exp) |
...
| openrouter | inclusionai | `ling-3.0-flash-vl:free` | 262K | $0 | $0 | — | **$0** |  | yes | [direct-api](https://openrouter.ai/inclusionai/ling-3.0-flash-vl:free) |
...
|---|---|---|---:|---|
| openrouter | direct-api | ok | 371 |  |
| litellm | direct-api | ok | 246 |  |
