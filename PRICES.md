...
> Generated `2026-09-17T08:44:55.019Z` · **744 models** across **17 price sources** · 55 models with an active promo/off-peak price · unit: **USD per 1M tokens** (CNY→USD @ 0.14) · blended = (3×input + 1×output)/4
...
|---|---|---|---:|---|
| deepseek | `deepseek-v4-flash` | openrouter | 500% | openrouter **$0.055** ($0.030/$0.130) · deepseek **$0.330** ($0.220/$0.660, promo) |
...
| deepseek | `deepseek-flash` | openrouter | 100% | openrouter **$0.263** ($0.150/$0.600) · litellm **$0.525** ($0.300/$1.20) |
...
| zai | `glm-5-2` | zai | 18% | zai **$1.82** ($1.12/$3.92) · openrouter **$2.15** ($1.40/$4.40) |
...
|---|---|---|---|---|---|---|---|---:|---|---|
| **OpenRouter** (`openrouter`) | aggregator | global | [openrouter.ai](https://openrouter.ai) | [pricing](https://openrouter.ai/models) | `https://openrouter.ai/api/v1` | `direct-api` | no | 365 | 2026-09-17 08:44 | ok |
| **LiteLLM price registry** (`litellm`) | aggregator | global | [github.com](https://github.com/BerriAI/litellm) | [pricing](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) | — | `direct-api` | no | 214 | 2026-09-17 08:44 | ok |
...
| **Google Gemini API** (`google`) | vendor | global | [ai.google.dev](https://ai.google.dev) | [pricing](https://ai.google.dev/gemini-api/docs/pricing) | `https://generativelanguage.googleapis.com/v1beta/openai/` | `public-page` | no | 8 | 2026-09-17 08:44 | ok |
| **DeepSeek** (`deepseek`) | vendor | cn | [platform.deepseek.com](https://platform.deepseek.com) | [pricing](https://api-docs.deepseek.com/quick_start/pricing) | `https://api.deepseek.com/v1` | `public-page` | no | 3 | 2026-09-17 08:44 | ok |
...
| openrouter | moonshot | `kimi-k3` | 1.05M | $3.00 | $15.00 | $0.300 | **$6.00** | batch $3.00/$15.00 | yes | [direct-api](https://openrouter.ai/moonshotai/kimi-k3) |
...
| litellm | mistral | `mistral-code-agent-latest` | 256K | $0.400 | $2.00 | — | **$0.800** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
...
| openrouter | deepseek | `deepseek-v4-flash-latest` | 1.31M | $0.030 | $0.130 | $0.010 | **$0.055** |  | yes | [direct-api](https://openrouter.ai/~deepseek/deepseek-v4-flash-latest) |
...
| openrouter | stealth | `union-alpha` | 262K | $0 | $0 | — | **$0** |  | yes | [direct-api](https://openrouter.ai/stealth/union-alpha) |
