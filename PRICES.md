...
> Generated `2026-09-13T08:24:03.831Z` · **737 models** across **17 price sources** · 53 models with an active promo/off-peak price · unit: **USD per 1M tokens** (CNY→USD @ 0.14) · blended = (3×input + 1×output)/4
...
| zai | `glm-5-2` | openrouter | 92% | openrouter **$0.950** ($0.600/$2.00) · zai **$1.82** ($1.12/$3.92) |
...
| zai | `glm-5-3` | openrouter | 28% | openrouter **$1.68** ($1.09/$3.43) · zai **$1.82** ($1.12/$3.92) · litellm **$2.15** ($1.40/$4.40) |
...
| deepseek | `deepseek-v4-pro` | openrouter | 14% | openrouter **$0.867** ($0.578/$1.73) · deepseek **$0.990** ($0.660/$1.98, promo) |
...
|---|---|---|---|---|---|---|---|---:|---|---|
| **OpenRouter** (`openrouter`) | aggregator | global | [openrouter.ai](https://openrouter.ai) | [pricing](https://openrouter.ai/models) | `https://openrouter.ai/api/v1` | `direct-api` | no | 363 | 2026-09-13 08:24 | ok |
| **LiteLLM price registry** (`litellm`) | aggregator | global | [github.com](https://github.com/BerriAI/litellm) | [pricing](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) | — | `direct-api` | no | 209 | 2026-09-13 08:24 | ok |
...
| **Google Gemini API** (`google`) | vendor | global | [ai.google.dev](https://ai.google.dev) | [pricing](https://ai.google.dev/gemini-api/docs/pricing) | `https://generativelanguage.googleapis.com/v1beta/openai/` | `public-page` | no | 8 | 2026-09-13 08:24 | ok |
| **DeepSeek** (`deepseek`) | vendor | cn | [platform.deepseek.com](https://platform.deepseek.com) | [pricing](https://api-docs.deepseek.com/quick_start/pricing) | `https://api.deepseek.com/v1` | `public-page` | no | 3 | 2026-09-13 08:24 | ok |
...
| openrouter | zai | `glm-5.2` | 1.05M | $0.600 | $2.00 | $0.150 | **$0.950** | batch $0.700/$2.20 | yes | [direct-api](https://openrouter.ai/z-ai/glm-5.2) |
...
| openrouter | zai | `glm-5.3` | 1.31M | $1.09 | $3.43 | $0.203 | **$1.68** | batch $0.700/$2.20 | yes | [direct-api](https://openrouter.ai/z-ai/glm-5.3) |
...
| openrouter | inference-net | `schematron-v2-turbo` | 128K | $0.030 | $0.150 | — | **$0.060** |  | yes | [direct-api](https://openrouter.ai/inference-net/schematron-v2-turbo) |
| openrouter | amazon | `nova-micro-v1` | 128K | $0.035 | $0.140 | — | **$0.061** |  | yes | [direct-api](https://openrouter.ai/amazon/nova-micro-v1) |
| openrouter | deepseek | `deepseek-v4-flash` | 1.05M | $0.049 | $0.099 | $0.0099 | **$0.062** |  | yes | [direct-api](https://openrouter.ai/deepseek/deepseek-v4-flash) |
