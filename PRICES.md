...
> Generated `2026-09-24T08:33:33.885Z` · **793 models** across **17 price sources** · 53 models with an active promo/off-peak price · unit: **USD per 1M tokens** (CNY→USD @ 0.14) · blended = (3×input + 1×output)/4
...
|---|---|---|---:|---|
| mistral | `mistral-large` | mistral | 700% | mistral **$0.375** ($0.250/$0.750, promo) · litellm **$0.750** ($0.500/$1.50) · openrouter **$3.00** ($2.00/$6.00) |
| mistral | `mistral-medium-3` | openrouter | 275% | openrouter **$0.800** ($0.400/$2.00) · litellm **$3.00** ($1.50/$7.50) |
| deepseek | `deepseek-v4-flash` | openrouter | 222% | openrouter **$0.102** ($0.030/$0.320) · deepseek **$0.330** ($0.220/$0.660, promo) |
...
| deepseek | `deepseek-flash` | openrouter | 88% | openrouter **$0.280** ($0.040/$1.00) · litellm **$0.525** ($0.300/$1.20) |
...
| zai | `glm-5-3` | openrouter | 67% | openrouter **$1.29** ($0.840/$2.64) · zai **$1.82** ($1.12/$3.92) · litellm **$2.15** ($1.40/$4.40) |
| deepseek | `deepseek-v4-flash-vision` | deepseek | 59% | deepseek **$0.330** ($0.220/$0.660, promo) · openrouter **$0.330** ($0.220/$0.660) · litellm **$0.525** ($0.300/$1.20) |
...
| deepseek | `deepseek` | litellm | 47% | litellm **$0.315** ($0.280/$0.420) · openrouter **$0.463** ($0.320/$0.890) |
| zai | `glm-5-turbo` | zai | 47% | zai **$1.29** ($0.700/$3.08) · openrouter **$1.90** ($1.20/$4.00) |
| deepseek | `deepseek-v4-pro` | openrouter | 43% | openrouter **$0.693** ($0.462/$1.39) · deepseek **$0.990** ($0.660/$1.98, promo) |
...
|---|---|---|---|---|---|---|---|---:|---|---|
| **OpenRouter** (`openrouter`) | aggregator | global | [openrouter.ai](https://openrouter.ai) | [pricing](https://openrouter.ai/models) | `https://openrouter.ai/api/v1` | `direct-api` | no | 381 | 2026-09-24 08:33 | ok |
| **LiteLLM price registry** (`litellm`) | aggregator | global | [github.com](https://github.com/BerriAI/litellm) | [pricing](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) | — | `direct-api` | no | 247 | 2026-09-24 08:33 | ok |
...
| **Google Gemini API** (`google`) | vendor | global | [ai.google.dev](https://ai.google.dev) | [pricing](https://ai.google.dev/gemini-api/docs/pricing) | `https://generativelanguage.googleapis.com/v1beta/openai/` | `public-page` | no | 8 | 2026-09-24 08:33 | ok |
| **DeepSeek** (`deepseek`) | vendor | cn | [platform.deepseek.com](https://platform.deepseek.com) | [pricing](https://api-docs.deepseek.com/quick_start/pricing) | `https://api.deepseek.com/v1` | `public-page` | no | 3 | 2026-09-24 08:33 | ok |
...
| openrouter | moonshot | `kimi-k3` | 1.05M | $3.00 | $15.00 | $0.300 | **$6.00** | batch $2.28/$11.40 | yes | [direct-api](https://openrouter.ai/moonshotai/kimi-k3) |
| openrouter | alibaba-modelstudio | `qwen3.8-max-prime` | 1M | $4.00 | $12.00 | $0.500 | **$6.00** |  | yes | [direct-api](https://openrouter.ai/qwen/qwen3.8-max-prime) |
...
| litellm | anthropic | `claude-opus-5-5` | 1M | $4.00 | $20.00 | $0.200 | **$8.00** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | openai | `daybreak-blue-latest` | 922K | $4.00 | $20.00 | $0.400 | **$8.00** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
...
| litellm | openai | `gpt-daybreak-blue-latest` | 922K | $4.00 | $20.00 | $0.400 | **$8.00** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
...
| litellm | xai | `grok-4.20-beta-latest-non-reasoning` | 1M | $1.25 | $2.50 | $0.200 | **$1.56** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | xai | `grok-4.20-beta-latest-reasoning` | 1M | $1.25 | $2.50 | $0.200 | **$1.56** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | xai | `grok-4.20-beta-non-reasoning` | 1M | $1.25 | $2.50 | $0.200 | **$1.56** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | xai | `grok-4.20-beta-reasoning` | 1M | $1.25 | $2.50 | $0.200 | **$1.56** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | xai | `grok-4.20-experimental-beta-0304-non-reasoning` | 1M | $1.25 | $2.50 | $0.200 | **$1.56** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | xai | `grok-4.20-experimental-beta-0304-reasoning` | 1M | $1.25 | $2.50 | $0.200 | **$1.56** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | xai | `grok-4.20-experimental-beta-non-reasoning-latest` | 1M | $1.25 | $2.50 | $0.200 | **$1.56** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | xai | `grok-4.20-experimental-beta-reasoning-latest` | 1M | $1.25 | $2.50 | $0.200 | **$1.56** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | xai | `grok-4.20-non-reasoning` | 1M | $1.25 | $2.50 | $0.200 | **$1.56** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | xai | `grok-4.20-non-reasoning-gv2` | 1M | $1.25 | $2.50 | $0.200 | **$1.56** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | xai | `grok-4.20-non-reasoning-latest` | 1M | $1.25 | $2.50 | $0.200 | **$1.56** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
...
| openrouter | thinkingmachines | `inkling` | 1.05M | $1.00 | $4.05 | $0.170 | **$1.76** |  | yes | [direct-api](https://openrouter.ai/thinkingmachines/inkling) |
...
| openrouter | deepseek | `deepseek-v4-pro` | 1.05M | $0.940 | $1.88 | $0.078 | **$1.17** |  | yes | [direct-api](https://openrouter.ai/deepseek/deepseek-v4-pro) |
...
| openrouter | zai | `glm-5.3` | 1.31M | $0.840 | $2.64 | $0.156 | **$1.29** | batch $0.450/$2.00 | yes | [direct-api](https://openrouter.ai/z-ai/glm-5.3) |
...
| litellm | xai | `grok-4.20` | 1M | $1.25 | $2.50 | $0.200 | **$1.56** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | xai | `grok-4.20-beta` | 1M | $1.25 | $2.50 | $0.200 | **$1.56** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | xai | `grok-4.20-beta-latest` | 1M | $1.25 | $2.50 | $0.200 | **$1.56** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | xai | `grok-4.20-experimental-beta-latest` | 1M | $1.25 | $2.50 | $0.200 | **$1.56** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | xai | `grok-4.20-multi-agent` | 1M | $1.25 | $2.50 | $0.200 | **$1.56** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | xai | `grok-4.20-multi-agent-beta-latest` | 1M | $1.25 | $2.50 | $0.200 | **$1.56** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | xai | `grok-4.20-multi-agent-experimental-beta-latest` | 1M | $1.25 | $2.50 | $0.200 | **$1.56** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | xai | `grok-4.20-multi-agent-latest` | 1M | $1.25 | $2.50 | $0.200 | **$1.56** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
...
| litellm | mistral | `devstral-small-latest` | 256K | $0.100 | $0.300 | $0.010 | **$0.150** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | deepseek | `deepseek-coder` | 128K | $0.140 | $0.280 | $0.014 | **$0.175** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| mistral | mistral | `codestral-latest` | — | $0.150 | $0.450 | $0.030 | **$0.225** | batch −50% | yes | [manual](https://mistral.ai/pricing#api-pricing) |
| litellm | mistral | `codestral-mamba-latest` | 256K | $0.250 | $0.250 | $0.025 | **$0.250** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
...
| litellm | mistral | `codestral-latest` | 128K | $0.300 | $0.900 | $0.030 | **$0.450** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | mistral | `mistral-code-fim-latest` | 128K | $0.300 | $0.900 | $0.030 | **$0.450** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | mistral | `mistral-code-latest` | 128K | $0.300 | $0.900 | $0.030 | **$0.450** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| openrouter | mistral | `codestral-2508` | 256K | $0.300 | $0.900 | $0.030 | **$0.450** | batch $0.150/$0.450 | yes | [direct-api](https://openrouter.ai/mistralai/codestral-2508) |
...
| litellm | openai | `gpt-5.1-codex-mini` | 400K | $0.250 | $2.00 | $0.025 | **$0.688** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
...
| litellm | mistral | `devstral-latest` | 256K | $0.400 | $2.00 | $0.040 | **$0.800** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | mistral | `devstral-medium-latest` | 256K | $0.400 | $2.00 | $0.040 | **$0.800** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | mistral | `mistral-code-agent-latest` | 256K | $0.400 | $2.00 | $0.040 | **$0.800** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
...
| openrouter | moonshot | `kimi-k2.7-code` | 262K | $0.656 | $3.30 | $0.180 | **$1.32** |  | yes | [direct-api](https://openrouter.ai/moonshotai/kimi-k2.7-code) |
...
| litellm | openai | `gpt-5-codex` | 272K | $1.25 | $10.00 | $0.125 | **$3.44** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | openai | `gpt-5.1-codex` | 400K | $1.25 | $10.00 | $0.125 | **$3.44** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | openai | `gpt-5.1-codex-max` | 400K | $1.25 | $10.00 | $0.125 | **$3.44** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
...
| litellm | openai | `gpt-5.2-codex` | 272K | $1.75 | $14.00 | $0.175 | **$4.81** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
...
| openrouter | inference-net | `schematron-v2-turbo` | 128K | $0.030 | $0.150 | $0.030 | **$0.060** |  | yes | [direct-api](https://openrouter.ai/inference-net/schematron-v2-turbo) |
...
| openrouter | inclusionai | `ling-3.0-flash-vl` | 262K | $0.060 | $0.180 | $0.012 | **$0.090** |  | yes | [direct-api](https://openrouter.ai/inclusionai/ling-3.0-flash-vl) |
...
| litellm | google | `gemini-omni-1.1-flash` | 1.05M | $1.50 | $9.00 | — | **$3.38** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | google | `gemini-omni-flash-preview` | 131K | $1.50 | $9.00 | — | **$3.38** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
...
| litellm | google | `gemma-4-26b-a4b-it` | 262K | $0 | $0 | — | **$0** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
| litellm | google | `gemma-4-31b-it` | 262K | $0 | $0 | — | **$0** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
...
| litellm | mistral | `labs-leanstral-1-5-1` | 262K | $0 | $0 | — | **$0** |  | yes | [direct-api](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) |
...
| openrouter | zai | `glm-5.2:free` | 33K | $0 | $0 | — | **$0** |  | yes | [direct-api](https://openrouter.ai/z-ai/glm-5.2:free) |
...
| openrouter | nex-agi | `nex-n2.5-mini:free` | 262K | $0 | $0 | — | **$0** |  | yes | [direct-api](https://openrouter.ai/nex-agi/nex-n2.5-mini:free) |
| openrouter | nex-agi | `nex-n2.5-pro:free` | 262K | $0 | $0 | — | **$0** |  | yes | [direct-api](https://openrouter.ai/nex-agi/nex-n2.5-pro:free) |
| openrouter | cohere | `north-mini-code:free` | 256K | $0 | $0 | — | **$0** |  | yes | [direct-api](https://openrouter.ai/cohere/north-mini-code:free) |
| openrouter | alibaba-modelstudio | `qwen3.8-27b:free` | 262K | $0 | $0 | — | **$0** |  | yes | [direct-api](https://openrouter.ai/qwen/qwen3.8-27b:free) |
| openrouter | stealth | `space-bunny-alpha` | 1M | $0 | $0 | — | **$0** |  | yes | [direct-api](https://openrouter.ai/stealth/space-bunny-alpha) |
