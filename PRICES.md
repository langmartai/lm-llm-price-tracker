...
> Generated `2026-09-21T09:04:48.330Z` · **748 models** across **17 price sources** · 55 models with an active promo/off-peak price · unit: **USD per 1M tokens** (CNY→USD @ 0.14) · blended = (3×input + 1×output)/4
...
| deepseek | `deepseek-v4-flash` | openrouter | 371% | openrouter **$0.070** ($0.040/$0.160) · deepseek **$0.330** ($0.220/$0.660, promo) |
...
|---|---|---|---|---|---|---|---|---:|---|---|
| **OpenRouter** (`openrouter`) | aggregator | global | [openrouter.ai](https://openrouter.ai) | [pricing](https://openrouter.ai/models) | `https://openrouter.ai/api/v1` | `direct-api` | no | 367 | 2026-09-21 09:04 | ok |
| **LiteLLM price registry** (`litellm`) | aggregator | global | [github.com](https://github.com/BerriAI/litellm) | [pricing](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) | — | `direct-api` | no | 216 | 2026-09-21 09:04 | ok |
...
| **Google Gemini API** (`google`) | vendor | global | [ai.google.dev](https://ai.google.dev) | [pricing](https://ai.google.dev/gemini-api/docs/pricing) | `https://generativelanguage.googleapis.com/v1beta/openai/` | `public-page` | no | 8 | 2026-09-21 09:04 | ok |
| **DeepSeek** (`deepseek`) | vendor | cn | [platform.deepseek.com](https://platform.deepseek.com) | [pricing](https://api-docs.deepseek.com/quick_start/pricing) | `https://api.deepseek.com/v1` | `public-page` | no | 3 | 2026-09-21 09:04 | ok |
...
| openrouter | deepseek | `deepseek-v4-flash-0731` | 1.31M | $0.040 | $0.160 | $0.016 | **$0.070** | batch $0.110/$0.330 | yes | [direct-api](https://openrouter.ai/deepseek/deepseek-v4-flash-0731) |
| openrouter | deepseek | `deepseek-v4-flash-latest` | 1.31M | $0.040 | $0.160 | $0.016 | **$0.070** |  | yes | [direct-api](https://openrouter.ai/~deepseek/deepseek-v4-flash-latest) |
