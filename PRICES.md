...
> Generated `2026-09-12T07:59:30.446Z` · **735 models** across **17 price sources** · 53 models with an active promo/off-peak price · unit: **USD per 1M tokens** (CNY→USD @ 0.14) · blended = (3×input + 1×output)/4
...
|---|---|---|---:|---|
| deepseek | `deepseek-v4-flash` | openrouter | 725% | openrouter **$0.040** ($0.030/$0.070) · deepseek **$0.330** ($0.220/$0.660, promo) |
...
| moonshot | `kimi-k3` | openrouter | 30% | openrouter **$4.61** ($2.30/$11.55) · litellm **$6.00** ($3.00/$15.00) · moonshot **$6.00** ($3.00/$15.00) |
...
|---|---|---|---|---|---|---|---|---:|---|---|
| **OpenRouter** (`openrouter`) | aggregator | global | [openrouter.ai](https://openrouter.ai) | [pricing](https://openrouter.ai/models) | `https://openrouter.ai/api/v1` | `direct-api` | no | 363 | 2026-09-12 07:59 | ok |
| **LiteLLM price registry** (`litellm`) | aggregator | global | [github.com](https://github.com/BerriAI/litellm) | [pricing](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) | — | `direct-api` | no | 207 | 2026-09-12 07:59 | ok |
...
| **Google Gemini API** (`google`) | vendor | global | [ai.google.dev](https://ai.google.dev) | [pricing](https://ai.google.dev/gemini-api/docs/pricing) | `https://generativelanguage.googleapis.com/v1beta/openai/` | `public-page` | no | 8 | 2026-09-12 07:59 | ok |
| **DeepSeek** (`deepseek`) | vendor | cn | [platform.deepseek.com](https://platform.deepseek.com) | [pricing](https://api-docs.deepseek.com/quick_start/pricing) | `https://api.deepseek.com/v1` | `public-page` | no | 3 | 2026-09-12 07:59 | ok |
...
| openrouter | moonshot | `kimi-k3` | 1.05M | $2.30 | $11.55 | $0.263 | **$4.61** | batch $3.00/$15.00 | yes | [direct-api](https://openrouter.ai/moonshotai/kimi-k3) |
...
| openrouter | deepseek | `deepseek-v4-pro` | 1.05M | $0.799 | $1.60 | $0.067 | **$0.999** |  | yes | [direct-api](https://openrouter.ai/deepseek/deepseek-v4-pro) |
...
| openrouter | deepseek | `deepseek-v4-flash-latest` | 1.31M | $0.030 | $0.070 | $0.0070 | **$0.040** |  | yes | [direct-api](https://openrouter.ai/~deepseek/deepseek-v4-flash-latest) |
...
| openrouter | deepseek | `deepseek-v4-flash` | 1.05M | $0.067 | $0.134 | $0.013 | **$0.083** |  | yes | [direct-api](https://openrouter.ai/deepseek/deepseek-v4-flash) |
| openrouter | google | `gemma-4-26b-a4b-it` | 262K | $0.042 | $0.220 | — | **$0.086** |  | yes | [direct-api](https://openrouter.ai/google/gemma-4-26b-a4b-it) |
