...
> Generated `2026-09-18T08:20:34.933Z` · **745 models** across **17 price sources** · 55 models with an active promo/off-peak price · unit: **USD per 1M tokens** (CNY→USD @ 0.14) · blended = (3×input + 1×output)/4
...
Models offered by 2+ price sources, sorted by price spread between the cheapest and priciest seller (effective price, promo applied). 122 models.
...
| deepseek | `deepseek-v4-flash` | openrouter | 340% | openrouter **$0.075** ($0.060/$0.120) · deepseek **$0.330** ($0.220/$0.660, promo) |
...
| zai | `glm-5-2` | openrouter | 141% | openrouter **$0.756** ($0.487/$1.56) · zai **$1.82** ($1.12/$3.92) |
| deepseek | `deepseek-flash` | openrouter | 122% | openrouter **$0.236** ($0.135/$0.540) · litellm **$0.525** ($0.300/$1.20) |
...
| moonshot | `kimi-k3` | openrouter | 39% | openrouter **$4.31** ($2.10/$10.95) · litellm **$6.00** ($3.00/$15.00) · moonshot **$6.00** ($3.00/$15.00) |
...
|---|---|---|---|---|---|---|---|---:|---|---|
| **OpenRouter** (`openrouter`) | aggregator | global | [openrouter.ai](https://openrouter.ai) | [pricing](https://openrouter.ai/models) | `https://openrouter.ai/api/v1` | `direct-api` | no | 366 | 2026-09-18 08:20 | ok |
| **LiteLLM price registry** (`litellm`) | aggregator | global | [github.com](https://github.com/BerriAI/litellm) | [pricing](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) | — | `direct-api` | no | 214 | 2026-09-18 08:20 | ok |
...
| **Google Gemini API** (`google`) | vendor | global | [ai.google.dev](https://ai.google.dev) | [pricing](https://ai.google.dev/gemini-api/docs/pricing) | `https://generativelanguage.googleapis.com/v1beta/openai/` | `public-page` | no | 8 | 2026-09-18 08:20 | ok |
| **DeepSeek** (`deepseek`) | vendor | cn | [platform.deepseek.com](https://platform.deepseek.com) | [pricing](https://api-docs.deepseek.com/quick_start/pricing) | `https://api.deepseek.com/v1` | `public-page` | no | 3 | 2026-09-18 08:20 | ok |
...
| openrouter | moonshot | `kimi-k3` | 1.05M | $2.10 | $10.95 | $0.230 | **$4.31** | batch $3.00/$15.00 | yes | [direct-api](https://openrouter.ai/moonshotai/kimi-k3) |
...
| openrouter | zai | `glm-5.2` | 1.05M | $0.487 | $1.56 | $0.091 | **$0.756** | batch $0.700/$2.20 | yes | [direct-api](https://openrouter.ai/z-ai/glm-5.2) |
...
| openrouter | deepseek | `deepseek-v4-flash-0731` | 1.31M | $0.060 | $0.120 | $0.012 | **$0.075** | batch $0.110/$0.330 | yes | [direct-api](https://openrouter.ai/deepseek/deepseek-v4-flash-0731) |
...
| openrouter | deepseek | `deepseek-v4-flash-latest` | 1.31M | $0.056 | $0.177 | $0.0088 | **$0.086** |  | yes | [direct-api](https://openrouter.ai/~deepseek/deepseek-v4-flash-latest) |
...
|---|---|---|---:|---|
| openrouter | direct-api | ok | 366 |  |
| litellm | direct-api | ok | 228 |  |
