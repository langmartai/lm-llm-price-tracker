...
> Generated `2026-09-11T08:08:29.028Z` · **729 models** across **17 price sources** · 54 models with an active promo/off-peak price · unit: **USD per 1M tokens** (CNY→USD @ 0.14) · blended = (3×input + 1×output)/4
...
| moonshot | `kimi-k3` | openrouter | 28% | openrouter **$4.68** ($2.34/$11.70) · litellm **$6.00** ($3.00/$15.00) · moonshot **$6.00** ($3.00/$15.00) |
| zai | `glm-5-2` | openrouter | 23% | openrouter **$1.48** ($0.966/$3.04) · zai **$1.82** ($1.12/$3.92) |
...
|---|---|---|---|---|---|---|---|---:|---|---|
| **OpenRouter** (`openrouter`) | aggregator | global | [openrouter.ai](https://openrouter.ai) | [pricing](https://openrouter.ai/models) | `https://openrouter.ai/api/v1` | `direct-api` | no | 357 | 2026-09-11 08:08 | ok |
| **LiteLLM price registry** (`litellm`) | aggregator | global | [github.com](https://github.com/BerriAI/litellm) | [pricing](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) | — | `direct-api` | no | 207 | 2026-09-11 08:08 | ok |
...
| **Google Gemini API** (`google`) | vendor | global | [ai.google.dev](https://ai.google.dev) | [pricing](https://ai.google.dev/gemini-api/docs/pricing) | `https://generativelanguage.googleapis.com/v1beta/openai/` | `public-page` | no | 8 | 2026-09-11 08:08 | ok |
| **DeepSeek** (`deepseek`) | vendor | cn | [platform.deepseek.com](https://platform.deepseek.com) | [pricing](https://api-docs.deepseek.com/quick_start/pricing) | `https://api.deepseek.com/v1` | `public-page` | no | 3 | 2026-09-11 08:08 | ok |
...
| openrouter | moonshot | `kimi-k3` | 1.05M | $2.34 | $11.70 | $0.261 | **$4.68** | batch $3.00/$15.00 | yes | [direct-api](https://openrouter.ai/moonshotai/kimi-k3) |
...
| openrouter | zai | `glm-5.2` | 1.05M | $0.966 | $3.04 | $0.193 | **$1.48** | batch $0.700/$2.20 | yes | [direct-api](https://openrouter.ai/z-ai/glm-5.2) |
...
| openrouter | deepseek | `deepseek-v4-flash-latest` | 1.31M | $0.040 | $0.160 | $0.013 | **$0.070** |  | yes | [direct-api](https://openrouter.ai/~deepseek/deepseek-v4-flash-latest) |
...
| openrouter | deepseek | `deepseek-v4-flash-0731` | 1.31M | $0.065 | $0.180 | $0.016 | **$0.094** | batch $0.110/$0.330 | yes | [direct-api](https://openrouter.ai/deepseek/deepseek-v4-flash-0731) |
