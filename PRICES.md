...
> Generated `2026-09-14T09:03:26.477Z` · **737 models** across **17 price sources** · 54 models with an active promo/off-peak price · unit: **USD per 1M tokens** (CNY→USD @ 0.14) · blended = (3×input + 1×output)/4
...
Models offered by 2+ price sources, sorted by price spread between the cheapest and priciest seller (effective price, promo applied). 121 models.

| Vendor | Model | Cheapest seller | Spread | Sellers (blended $/1M, in/out) |
|---|---|---|---:|---|
| deepseek | `deepseek-v4-flash` | openrouter | 525% | openrouter **$0.053** ($0.035/$0.106) · deepseek **$0.330** ($0.220/$0.660, promo) |
...
| zai | `glm-5-2` | openrouter | 73% | openrouter **$1.05** ($0.683/$2.15) · zai **$1.82** ($1.12/$3.92) |
...
| moonshot | `kimi-k2-7-code` | moonshot | 37% | moonshot **$1.03** ($0.570/$2.40, promo) · openrouter **$1.41** ($0.710/$3.50) |
...
|---|---|---|---|---|---|---|---|---:|---|---|
| **OpenRouter** (`openrouter`) | aggregator | global | [openrouter.ai](https://openrouter.ai) | [pricing](https://openrouter.ai/models) | `https://openrouter.ai/api/v1` | `direct-api` | no | 363 | 2026-09-14 09:03 | ok |
| **LiteLLM price registry** (`litellm`) | aggregator | global | [github.com](https://github.com/BerriAI/litellm) | [pricing](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json) | — | `direct-api` | no | 209 | 2026-09-14 09:03 | ok |
...
| **Google Gemini API** (`google`) | vendor | global | [ai.google.dev](https://ai.google.dev) | [pricing](https://ai.google.dev/gemini-api/docs/pricing) | `https://generativelanguage.googleapis.com/v1beta/openai/` | `public-page` | no | 8 | 2026-09-14 09:03 | ok |
| **DeepSeek** (`deepseek`) | vendor | cn | [platform.deepseek.com](https://platform.deepseek.com) | [pricing](https://api-docs.deepseek.com/quick_start/pricing) | `https://api.deepseek.com/v1` | `public-page` | no | 3 | 2026-09-14 09:03 | ok |
...
| openrouter | zai | `glm-5.2` | 1.05M | $0.683 | $2.15 | $0.127 | **$1.05** | batch $0.700/$2.20 | yes | [direct-api](https://openrouter.ai/z-ai/glm-5.2) |
...
| openrouter | moonshot | `kimi-k2.7-code` | 262K | $0.710 | $3.50 | $0.150 | **$1.41** |  | yes | [direct-api](https://openrouter.ai/moonshotai/kimi-k2.7-code) |
...
| openrouter | deepseek | `deepseek-v4-flash-latest` | 1.31M | $0.035 | $0.106 | $0.0011 | **$0.053** |  | yes | [direct-api](https://openrouter.ai/~deepseek/deepseek-v4-flash-latest) |
...
|---|---|---|---:|---|
| openrouter | direct-api | ok | 363 |  |
| litellm | direct-api | ok | 223 |  |
